      ...
      <Container>
        <Row>
          ...
          <Col md={4}>
            ...
            <address>
              ...
              Anytown, ST 12345<br />
              <abbr title="Phone">P:</abbr> (555) 123-4567<br />
              <abbr title="Email">E:</abbr> info@markspsychiatry.com
            </address>
          </Col>
        </Row>
        <hr className="my-4" />
        <Row>
          <Col className="text-center">
            <p className="mb-0">&copy; {new Date().getFullYear()} Mark's Psychiatry. All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
